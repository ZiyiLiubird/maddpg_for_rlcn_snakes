...
class MADDPG(DDPG):
    ...
    """
    def __init__(self, obs_dim, act_dim, num_agent, args, agent_init_params, alg_types,
        ...
        """
        super(MADDPG, self).__init__(obs_dim, act_dim, num_agent, args)
